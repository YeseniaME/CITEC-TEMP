<div class="row template sticky">
	...
	<div class="tooltip">
		Por favor, seleccione qué grupo de plantillas se debe utilizar para el código generado.
	</div>
	<?php echo $this->error($model,'template'); ?>
</div>

<div class="buttons">
	<?php echo CHtml::submitButton('Vista previa',array('name'=>'preview')); ?>

	<?php if($model->status===CCodeModel::STATUS_PREVIEW && !$model->hasErrors()): ?>
		<?php echo CHtml::submitButton('Generar',array('name'=>'generate')); ?>
	<?php endif; ?>
</div>
