...
class CrudCode extends CCodeModel
{
	...
	public function successMessage()
	{
		...
		return "El controlador se ha generado con éxito. Puedes verlo aqui $link.";
	}
	...
	public function validateModel($attribute,$params)
	{
		...
		else
		{
			...
			if($table->primaryKey===null)
				$this->addError('model',"Table '{$table->name}' no tiene una clave primaria.");
			elseif(is_array($table->primaryKey))
				$this->addError('model',"Table '{$table->name}' tiene una clave principal compuesta que no está soportada por el generador crud.");
			else
			{
